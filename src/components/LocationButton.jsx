    ...
    useEffect(() => {
        ...
        const customControl = L.Control.extend({
            ...
            options: {
                ...
                style: "width: 34px; height: 34px; left: 0; margin-top: 0; display: flex; cursor: pointer; justify-content: center; font-size: 2rem;",
            },
            ...
            _locateMap: function () {
                const locateActive = document.querySelector(
                    `.locateButton`
                );
                const locate = locateActive.classList.contains(
                    'locateActive'
                );
            ...
            removeLocate: function () {
                this._map.eachLayer(function (layer) {
                    if (layer instanceof L.Marker) {
                        ...
                        if (
                            icon?.options.className === 'locatedAnimation'
                        ) {
